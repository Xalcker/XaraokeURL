...
(function (root, factory) {
  ...
  const MESSAGES = {
    es: {
      ...
      "remote.controlsLocked": "Solo quien canta puede pausar o saltar",
      "remote.voteSkip": "Votar para saltar",
      ...
      "tour.playPause.text": "Pausa o reanuda tu canción para toda la sala. El ícono muestra lo que pasará al tocarlo. Solo funciona mientras suena la tuya: con la de otra persona (o sin nada en la cola) está desactivado.",
      "tour.skip.title": "Saltar canción",
      "tour.skip.text": "Salta tu canción mientras suena; antes te pide confirmar. Con la de otra persona está desactivado, salvo que esa persona lleve un rato sin conexión.",
    ...
    en: {
      ...
      "remote.controlsLocked": "Only the singer can pause or skip",
      "remote.voteSkip": "Vote to skip",
      ...
      "tour.skip.text": "Skips your song while it's playing; it asks you to confirm first. With someone else's song it's disabled, unless that person has been offline for a while.",
