...
(function (root, factory) {
  ...
  const MESSAGES = {
    es: {
      ...
      "yt.fallback.instrumental": "No hubo versiones karaoke: estas son versiones instrumentales.",
      "yt.fallback.none": "No hubo versiones karaoke ni instrumentales: estos son los resultados de tu búsqueda, tal cual.",
    ...
    en: {
      ...
      "yt.fallback.instrumental": "No karaoke versions found: these are instrumental versions.",
      "yt.fallback.none": "No karaoke or instrumental versions found: these are the results for your search as typed.",
